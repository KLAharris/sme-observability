...
echo ""
echo "[1/3] Setting data directory permissions..."
sudo mkdir -p /data/prometheus /data/loki /data/tempo /data/grafana /data/alloy
sudo chown -R 65534:65534 /data/prometheus
sudo chown -R 10001:10001 /data/loki
sudo chown -R 10001:10001 /data/tempo
sudo chown -R 472:472 /data/grafana
sudo chown -R 473:473 /data/alloy
...
echo "  Grafana    : http://18.143.253.170:3000"
echo ""
